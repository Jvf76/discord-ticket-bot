...
- **📬 Envio automático** — o transcript é enviado por DM ao solicitante e registrado no canal de logs
...
O arquivo é enviado por DM ao solicitante e postado no canal de logs.
